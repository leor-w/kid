...
//}
//
//func (r *ConnectionValues) GetOne(key string) interface{} {
//	args := *r
//	n := len(args)
//	for i := 0; i < n; i++ {
//		kv := &args[i]
...
//		}
//
//		customMessage, err := c.server.messageSerializer.Decode(receivedEvt, data)
...
//	return c.values.GetOne(key)
//}
//
//func (c *connection) GetValueArrString(key string) []string {
//	if v := c.values.GetOne(key); v != nil {
